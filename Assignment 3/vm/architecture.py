...
OPS = {
    ...
    "inc": {"code": 0x8, "fmt": "r-"},  # Increase by 1
    "dec": {"code": 0x9, "fmt": "r-"},  # Decrease by 1
    "swp": {"code": 0xA, "fmt": "rr"},  # Swap register
    "beq": {"code": 0xB, "fmt": "rv"},  # Branch if equal
    "bne": {"code": 0xC, "fmt": "rv"},  # Branch if not equal
    "prr": {"code": 0xD, "fmt": "r-"},  # Print register
    "prm": {"code": 0xE, "fmt": "r-"},  # Print memory
}
